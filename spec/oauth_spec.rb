...
describe Elmas::OAuth do
  describe "#" do
    it "authorize" do
      stream = File.read("spec/exact_login.html")
      login_params = { client_id: "client_id", redirect_uri: "redirect_uri", response_type: "code" }
      stub_request(:get, "https://start.exactonline.nl/api/oauth2/auth/").with(query: login_params).to_return(body: stream, headers: { content_type: "text/html" })
